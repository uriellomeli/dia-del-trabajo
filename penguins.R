pacman::p_load(tidyverse, ggplot2, ggridges, cowplot, scales, magick, extrafont, ggpubr, patchwork, rsvg)
...
## Gentoo Image
ggdraw() +
  draw_image("gentoo_1.png", width = 1.2, height = 1.3) +
...
#final plot
final_plot <- plot_grid(header_plot, # 3.1
                        image_row, # 3.5
                        row1, # 4.5
                        legend, # 0.7
                        p6, # 1
...
#saving
ggsave("penguinsbill_plot.png", final_plot, height = 8, width = 10, units = "in", dpi = 300)
